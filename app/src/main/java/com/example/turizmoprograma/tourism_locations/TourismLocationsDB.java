...
public class TourismLocationsDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(ROW_30);
        //Monuments
        String ROW_31 = "INSERT INTO " + TABLE_LOCATIONS + " VALUES (" +
                "31,'memorialas; route','Paminklas LDK didžiajam kunigaikščiui Gediminui','Šventaragio g. 2, Vilnius','Jei  būtų įmanoma persikelti į Lietuvos LDK didžiojo kunigaikščio Gedimino valdymo laikus, išvystumėte dvigubai didesnę Lietuvos teritoriją. Diplomatinėmis savybėmis garsėjęs valdovas savo krašte paliko nepaprastai gilų pėdsaką. Paminklas LDK didžiajam kunigaikščiui Gediminui – viena iš „kalbančių Vilniaus skulptūrų”. Tai matyti iš prie skulptūros pjedestalo pritvirtintos mėlynos lentelės, kviečiančios išklausyti skulptūrą kalbant. Jums tik reikės išmaniojo telefono, kuriuo turėsite pasirinkti vieną iš dviejų lentelėje nurodytų alternatyvų: nuskenuoti QR kodą arba surinkti nurodytą URL adresą.', 54.6846752, 25.2886371," + R.drawable.paminklasgediminas + ")";
        db.execSQL(ROW_31);
        String ROW_32 = "INSERT INTO " + TABLE_LOCATIONS + " VALUES (" +
                "32,'memorialas; route','Miesto vartų sargybinio skulptūra','Pylimo g. 24, Vilnius','Ši skulptūra – žymaus skulptoriaus Stanislovo Kuzmos diplominis darbas, sukurtas baigiant Dailės institutą (dabar Vilniaus dailės akademija). Skulptoriui baigiant studijas artėjo 650-osios Vilniaus įkūrimo metinės, tad skulptūra buvo įvardyta kaip puošybinė pastato detalė ir pavadinta tiesiog „Riteriu“. Iš pradžių skulptūra buvo medinė, dėl ideologinės cenzūros Gedimino stulpų nebuvo. Skulptūra iš vario buvo išlieta Lietuvai atkūrus Nepriklausomybę, tuomet ją ir papildė Gediminaičių stulpai.', 54.67603855, 25.281411114296752," + R.drawable.sargybinisskulptura + ")";
        db.execSQL(ROW_32);
        String ROW_33 = "INSERT INTO " + TABLE_LOCATIONS + " VALUES (" +
                "33,'memorialas','Žemaitės skulptūra','Gedimino pr., Vilnius','Žemaitė (Julija Beniuševičiūtė-Žymantienė, 1845–1921 m.) – garsi XIX amžiaus pabaigos – XX amžiaus pradžios rašytoja, visuomenės ir kultūros veikėja, prisidėjusi prie lietuvių kalbos ir literatūros puoselėjimo. Ji - pirmoji lietuvių rašytoja, leidusi savo kūryba iš arčiau pažinti moters gyvenimą. Iki tol rašę rašytojai vyrai neperteikdavo moters pasaulėžiūros. Rašytojos skulptūra įkurdinta Žemaitės skvere, esančiame šalia Gedimino prospekto. Pažinsite ją iš parimusios pozos ir užrištos skarelės. Skulptūros autorius – skulptorius Petras Aleksandravičius.', 54.6884527, 25.2740363," + R.drawable.zemaiteskulptura + ")";
        db.execSQL(ROW_33);
        String ROW_34 = "INSERT INTO " + TABLE_LOCATIONS + " VALUES (" +
                "34,'memorialas; route','Karaliaus Mindaugo paminklas','Arsenalo g. 1, Vilnius','Kadangi tai pirmasis ir paskutinysis Lietuvos karalius, paminklas jam – labai simbolinis. Lietuvos valstybingumo istorijoje istoriniai šaltiniai ir istoriografija leidžia susidaryti tik labai abstraktų jo portretą. Aplink paminklą matyti saulės kalendorius, kuriame sužymėtos ne tik krikščioniškos, tačiau ir pagoniškos šventės. Tai atskleidžia, kad karalius Mindaugas savo religijos neatsisakė visiškai, o krikščionybės priėmimas dalinai buvo susijęs su siekiu tapti karaliumi.', 54.687366, 25.289186523648198," + R.drawable.mindaugaspaminklas + ")";
        db.execSQL(ROW_34);
        String ROW_35 = "INSERT INTO " + TABLE_LOCATIONS + " VALUES (" +
                "35,'memorialas; route','Inskripcijos sovietinių represijų aukoms','Gedimino pr. 40, Vilnius','Eidami Gedimino prospektu akimis užkliūsite už pastato sienos, aprašinėtos žmonių vardais ir datomis. Šie vardai – didvyrių. Apygardos Teismo rūmų pastato cokolyje, dailininko Gitenio Umbraso iniciatyva, iškaltos inskripcijos sovietinių represijų aukoms atminti yra vienas iš nedaugelio netradiciniams paminklams priskirtinų objektų Lietuvoje. Dėl ypač glaudaus paminklo santykio su aplinka ir kontekstu jį galima pavadinti „įvietintu“.', 54.6881581, 25.2712152," + R.drawable.aukossiena + ")";
        db.execSQL(ROW_35);
    }
