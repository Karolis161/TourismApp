...
public class TourismLocationsDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String ROW_23 = "INSERT INTO " + TABLE_LOCATIONS + " VALUES (" +
                "23,'religija; muziejus; route','Bažnytinio paveldo muziejus','Šv. Mykolo g. 9, Vilnius','Vilniaus senamiestyje, Šv. Mykolo bažnyčios ir buvusio Bernardinų vienuolyno ansamblyje, įsikūręs unikalus Bažnytinio paveldo muziejus sudomins ne tik sakralinio meno mėgėjus, bet ir kiekvieną senąja Lietuvos kultūra besidomintį žmogų. Bažnytinio paveldo muziejuje saugomos ir visuomenei pristatomos sakralinės vertybės. Čia akį traukia prabangūs auksakalystės šedevrai, puošnūs bažnytinės tekstilės pavyzdžiai. Lankytojai muziejuje susipažins su išskirtine Vilniaus katedros lobyno istorija ir vertingiausiais jo eksponatais.', 54.8486367, 25.4657212," + R.drawable.paveldomuziejus + ")";
        db.execSQL(ROW_23);
